                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <input type="text" value="$ad->admin_name " placeholder="Full Name"
                                    ...
                                    <div class="col-md-4">
                                        <label>Email</label>
                                        <div class="form-group">
                                            <input type="text" value="$ad->admin_email" placeholder=" Email"
                                    ...
                                    <div class="col-md-4">
                                        <label>Phone</label>
                                        <div class="form-group">
                                            <input type="text" value="$ad->admin_phone " placeholder="Phone"
